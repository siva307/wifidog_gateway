...
#define CP_SSL_CERT_FILE "/etc/certs_default/wildcard.pem"
#define CP_SSL_KEY_FILE "/etc/certs_default/wildcardkey.pem"
#define CP_SSL_CACERT_FILE "/etc/certs_default/cacert.pem"
#define PASSWORD "help"
